...
async function main() {
  ...
  const jobs = [
    ...
    },
    {
      ...
      description: 'Упаковка готовой продукции в коробки. Работа на конвейере. Обучение на месте.',
      location: 'Ташкент, Бектемир',
      salary: 200000,
      skill: 'Упаковщик',
      availability: 'Сменный график',
      requirements: ['Внимательность', 'Быстрота рук'],
      benefits: ['Питание', 'Развозка']
    },
    {
      title: 'Сантехник',
      ...
      benefits: ['Стабильная оплата', 'Дружный коллектив']
    }
  ];
