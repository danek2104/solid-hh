...
export const styles = StyleSheet.create({
  ...
  skillModalSectionTitle: {
    fontSize: 16,
    fontWeight: '700',
    color: theme.text,
    marginBottom: 12,
  },
  skillModalOptionsGrid: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: 8,
    marginBottom: 8,
  ...
  skillModalOptionSelected: {
    backgroundColor: theme.primary,
    borderColor: theme.primary,
  },
  skillModalOptionText: {
    fontSize: 14,
    fontWeight: '500',
    color: theme.text,
  },
  skillModalOptionTextSelected: {
    color: '#fff',
  },
  skillModalPreview: {
    marginTop: 20,
  ...
  skillModalPreviewLabel: {
    fontSize: 12,
    fontWeight: '600',
    color: theme.muted,
    marginBottom: 4,
  },
  skillModalPreviewText: {
    fontSize: 18,
    fontWeight: '700',
    color: theme.primary,
  },
