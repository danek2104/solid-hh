...
export default function PersonalInfoScreen() {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
      <ProgressBar progress={0.2} color={theme.primary} style={styles.progress} />
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{flex: 1}}>
        <ScrollView contentContainerStyle={styles.content}>
          <Animated.View entering={FadeInDown.delay(200)}>
            <Text variant="headlineSmall" style={[styles.header, { color: theme.text }]}>{t('personalInfo')}</Text>
            <Text variant="bodyMedium" style={[styles.subHeader, { color: theme.textSecondary }]}>{t('fillData')}</Text>
