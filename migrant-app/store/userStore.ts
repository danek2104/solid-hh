...
export const useUserStore = create<UserState>((set, get) => ({
  ...
  login: (backendUser) => {
      ...
      const userProfile: UserProfile = {
          ...
          role: backendUser.role || 'seeker',
          companyName: backendUser.company_name || '', // Map company_name
          companyDescription: backendUser.company_description || '', // Map company_description
          website: backendUser.website || '', // Map website
          avatarUrl: backendUser.avatar_url || '', // Map avatar_url
      ...
      const isProfileFilled = !!(userProfile.firstName && userProfile.lastName && userProfile.firstName !== 'Test' && userProfile.firstName !== 'Новый');
